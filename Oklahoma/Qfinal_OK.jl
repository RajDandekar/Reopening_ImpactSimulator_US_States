...
save("QFinal_QuarHeatmap_OK_QSIR_Deadn.jld",  "β_parameter", p3n[52],"γ_parameter", p3n[53],"δ_parameter", p3n[54], "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)
...
# ps = Flux.params(p3)
#
D = load("QFinal_QuarHeatmap_OK_QSIR_Deadn.jld")
...
# Flux.train!(loss_adjoint, ps, datan, opt, cb = cb)
#
# #gif(anim,"Quar_Dead_OK.gif", fps=15)
# L = findmin(Loss)
# idx = L[2]
# idx1 = (idx-1)*54 +1
# idx2 = idx*54
...
savefig("QFinal_Quar_Stage2_OK_1d.pdf")
...
Plots.savefig("QFinal_Quar_Stage2_OK_2d.pdf")
...
Plots.savefig("QFinal_Quar_Stage2_OK_3d.pdf")


Q_OK = ((Q_parameter[30] - Q_parameter[1]) /u0[1])

save("QFinal_QuarHeatmap_OK_QSIR_Deadn_Stage2.jld", "Q_OK", Q_OK, "prediction", prediction, "Q_parameter", Q_parameter, "Reff", Reff, "Transition", Transition, "β_parameter", p3n[52],"γ_parameter", γ_parameter,"δ_parameter", δ_parameter, "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)


########CLEAN PLOTS###########
D = load("QFinal_QuarHeatmap_OK_QSIR_Deadn_Stage2.jld")
...
plot!(t, prediction[3, :], ylims = (-0.025*maximum(Recovered + Dead),3*maximum(Infected)), right_margin = 5mm, xaxis = "Days post 500 infected", label = "Prediction ", legend = :topleft, framestyle = :box, left_margin = 5mm, bottom_margin =5mm, top_margin = 5mm, grid = :off, color = :blue, linewidth  = 4, foreground_color_legend = nothing, background_color_legend = nothing,  yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman", legendfontsize = 1))

savefig("Clean_QFinal_Quar_Stage2_OK_1dn.pdf")
...
Plots.savefig("Clean_QFinal_Quar_Stage2_OK_2d.pdf")
...
plot!([24-0.01,24+0.01],[0.0, 0.6],lw=3,color=:green,label="Reopening begins",linestyle = :dash)

#plot!([15-0.01,15+0.01],[0.0, 0.6],lw=3,color=:red,label="Inflection point in learnt Q(t)",linestyle = :dash)

Plots.savefig("Clean_QFinal_Quar_Stage2_OK_3dn.pdf")
...
plot!(t, prediction[3, :], ylims = (-0.05*maximum(Recovered + Dead),3.75*maximum(Infected)), right_margin = 5mm, xaxis = "Days post 500 infected", label = "Prediction ", legend = :topleft, framestyle = :box, left_margin = 5mm, bottom_margin =5mm, top_margin = 5mm, grid = :off, color = :darkgreen, linewidth  = 4, foreground_color_legend = nothing, background_color_legend = nothing,  yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman", legendfontsize = 1))

savefig("OK_reopen_1.pdf")
