...
######################## STAGE 1###############
vars = matread("/Users/Emma/Documents/School/2019-2020/Covid Urop/Run Code 7:15/Rise_TX_Track.mat")

Random.seed!(60)

Infected = vars["TX_Infected_All"]
Recovered = vars["TX_Recovered_All"]
Dead= vars["TX_Dead_All"]
Time = vars["TX_Time"]
...
u0 = Float64[29000000.0, 576, 5, 10]
tspan = (0, 116.0)
datasize = 116;
...
save("QFinal_QuarHeatmap_TX_QSIR_Deadn.jld",  "β_parameter", p3n[52],"γ_parameter", p3n[53],"δ_parameter", p3n[54], "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)
...
D = load("QFinal_QuarHeatmap_TX_QSIR_Deadn.jld")
...
#gif(anim,"Quar_Dead_TX.gif", fps=15)
L = findmin(Loss)
idx = L[2]
idx1 = (idx-1)*54 +1
idx2 = idx*54
...
savefig("QFinal_Quar_Stage2_TX_1d.pdf")
...
Plots.savefig("QFinal_Quar_Stage2_TX_2d.pdf")
...
Plots.savefig("QFinal_Quar_Stage2_TX_3d.pdf")


Q_TX = ((Q_parameter[30] - Q_parameter[1]) /u0[1])

save("QFinal_QuarHeatmap_TX_QSIR_Deadn_Stage2.jld", "Q_TX", Q_TX, "prediction", prediction, "Q_parameter", Q_parameter, "Reff", Reff, "Transition", Transition, "β_parameter", p3n[52],"γ_parameter", γ_parameter,"δ_parameter", δ_parameter, "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)


########CLEAN PLOTS###########
D = load("QFinal_QuarHeatmap_TX_QSIR_Deadn_Stage2.jld")
...
savefig("Clean_QFinal_Quar_Stage2_TX_1dn.pdf")
...
Plots.savefig("Clean_QFinal_Quar_Stage2_TX_2d.pdf")
...
plot!([41-0.01,41+0.01],[0.0, 0.6],lw=3,color=:green,label="Stay-at-home order expires",linestyle = :dash)
...
Plots.savefig("Clean_QFinal_Quar_Stage2_TX_3dn.pdf")
...
vars = matread("/Users/Emma/Documents/School/2019-2020/Covid Urop/csse_covid_19_data/csse_covid_19_daily_reports/Rise_TX_Track.mat")
Infected = vars["TX_Infected_All"]
Recovered = vars["TX_Recovered_All"]
Dead= vars["TX_Dead_All"]
Time = vars["TX_Time"]
