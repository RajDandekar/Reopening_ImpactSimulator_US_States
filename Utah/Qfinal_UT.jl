...
######################## STAGE 1###############
vars = matread("/Users/Emma/Documents/School/2019-2020/Covid Urop/Run Code 7:15/Rise_UT_Track.mat")

Random.seed!(50)

Infected = vars["UT_Infected_All"]
Recovered = vars["UT_Recovered_All"]
Dead= vars["UT_Dead_All"]
Time = vars["UT_Time"]
...
save("QFinal_QuarHeatmap_UT_QSIR_Deadn.jld",  "β_parameter", p3n[52],"γ_parameter", p3n[53],"δ_parameter", p3n[54], "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)

##############STAGE 2#########################

# vars = matread("/Users/Emma/Documents/School/2019-2020/Covid Urop/Run Code 6:30/Rise_UT_Track.mat")
#
# Random.seed!(50)
#
# Infected = vars["UT_Infected_All"]
...
# ps = Flux.params(p3)
#
D = load("QFinal_QuarHeatmap_UT_QSIR_Deadn.jld")
...
# Flux.train!(loss_adjoint, ps, datan, opt, cb = cb)
#
# #gif(anim,"Quar_Dead_UT.gif", fps=15)
# L = findmin(Loss)
# idx = L[2]
# idx1 = (idx-1)*54 +1
# idx2 = idx*54
...
Plots.savefig("QFinal_Quar_Stage2_UT_2d.pdf")
...
Plots.savefig("QFinal_Quar_Stage2_UT_3d.pdf")


Q_UT = ((Q_parameter[30] - Q_parameter[1]) /u0[1])

save("QFinal_QuarHeatmap_UT_QSIR_Deadn_Stage2.jld", "Q_UT", Q_UT, "prediction", prediction, "Q_parameter", Q_parameter, "Reff", Reff, "Transition", Transition, "β_parameter", p3n[52],"γ_parameter", γ_parameter,"δ_parameter", δ_parameter, "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)


########CLEAN PLOTS###########
D = load("QFinal_QuarHeatmap_UT_QSIR_Deadn_Stage2.jld")
...
plot!(t, prediction[3, :], ylims = (-0.05*maximum(Recovered + Dead),1.75*maximum(Infected)), right_margin = 5mm, xaxis = "Days post 500 infected", label = "Prediction ", legend = :topleft, framestyle = :box, left_margin = 5mm, bottom_margin =5mm, top_margin = 5mm, grid = :off, color = :blue, linewidth  = 4, foreground_color_legend = nothing, background_color_legend = nothing,  yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman", legendfontsize = 1))

savefig("Clean_QFinal_Quar_Stage2_UT_1dn.pdf")

using LaTeXStrings

#plot([0, Transition[1]], [80, 80],fill=(0,:lightpink), markeralpha=0, label = "")
#plot!([Transition[1], datasize], [80, 80],fill=(0,:aliceblue), markeralpha=0, label = "")
scatter(t[5:end], Reff[5:end], xlims = (0, datasize), ylims = (0, 5), xlabel = "Days post 500 infected", label = string("Covid spread parameter ", L"C_{p}"), legend = :topright, color = :black, framestyle = :box, grid =:off, foreground_color_legend = nothing, background_color_legend = nothing, yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman"), legendfontsize = 12, left_margin = 5mm, bottom_margin= 5mm)
f(x) = 1
plot!(f, xlims = (0,datasize), color = :blue, linewidth = 3, label = L"C_{p} = 1")

Plots.savefig("Clean_QFinal_Quar_Stage2_UT_2d.pdf")
...
plot!([34-0.01,34+0.01],[0.0, 0.6],lw=3,color=:green,label="Reopening begins",linestyle = :dash)

#plot!([13-0.01,13+0.01],[0.0, 0.6],lw=3,color=:red,label="Inflection point in learnt Q(t)",linestyle = :dash)

Plots.savefig("Clean_QFinal_Quar_Stage2_UT_3dn.pdf")
...
vars = matread("/Users/Emma/Documents/School/2019-2020/Covid Urop/csse_covid_19_data/csse_covid_19_daily_reports/Rise_UT_Track.mat")
Infected = vars["UT_Infected_All"]
Recovered = vars["UT_Recovered_All"]
Dead= vars["UT_Dead_All"]
Time = vars["UT_Time"]
...
plot!([reopening_day-0.01,reopening_day+0.01],[0.0, 0.6],lw=3,color=:green,label="Reopening begins",linestyle = :dash)

savefig("UT_reopen_2.pdf")
