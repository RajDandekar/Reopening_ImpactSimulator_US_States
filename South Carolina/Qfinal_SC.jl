...
######################## STAGE 1###############
vars = matread("/Users/Emma/Documents/School/2019-2020/Covid Urop/csse_covid_19_data/csse_covid_19_daily_reports/Rise_SC_Track.mat")

Random.seed!(50)

Infected = vars["SC_Infected_All"]
Recovered = vars["SC_Recovered_All"]
Dead= vars["SC_Dead_All"]
Time = vars["SC_Time"]
...
u0 = Float64[5150000.0, 529, 13, 10]
tspan = (0, 110.0)
datasize = 110;
...
save("QFinal_QuarHeatmap_SC_QSIR_Deadn.jld",  "β_parameter", p3n[52],"γ_parameter", p3n[53],"δ_parameter", p3n[54], "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)
...
# ps = Flux.params(p3)
#
D = load("QFinal_QuarHeatmap_SC_QSIR_Deadn.jld")
...
# Flux.train!(loss_adjoint, ps, datan, opt, cb = cb)
#
# #gif(anim,"Quar_Dead_SC.gif", fps=15)
# L = findmin(Loss)
# idx = L[2]
# idx1 = (idx-1)*54 +1
# idx2 = idx*54
...
Plots.savefig("QFinal_Quar_Stage2_SC_2d.pdf")
...
Plots.savefig("QFinal_Quar_Stage2_SC_3d.pdf")


Q_SC = ((Q_parameter[30] - Q_parameter[1]) /u0[1])

save("QFinal_QuarHeatmap_SC_QSIR_Deadn_Stage2.jld", "Q_SC", Q_SC, "prediction", prediction, "Q_parameter", Q_parameter, "Reff", Reff, "Transition", Transition, "β_parameter", p3n[52],"γ_parameter", γ_parameter,"δ_parameter", δ_parameter, "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)


########CLEAN PLOTS###########
D = load("QFinal_QuarHeatmap_SC_QSIR_Deadn_Stage2.jld")
...
savefig("Clean_QFinal_Quar_Stage2_SC_1dn.pdf")
...
Plots.savefig("Clean_QFinal_Quar_Stage2_SC_2d.pdf")
...
plot!([38-0.01,38+0.01],[0.0, 0.6],lw=3,color=:green,label="Stay-at-home order expires",linestyle = :dash)
...
Plots.savefig("Clean_QFinal_Quar_Stage2_SC_3dn.pdf")
