...
D = load("/Users/Emma/QFinal_QuarHeatmap_NV_QSIR_Deadn_Stage2.jld")
...
plot!(t, Mean_Infected, ribbon=(Mean_Infected .- Low_quantile_Infected,High_quantile_Infected .- Mean_Infected), fillalpha=0.6, c=:red, lab="Prediction", linewidth = 3, ylims = (-1.25*maximum(Recovered + Dead),1.5*maximum(Infected)))
...
plot!(t, Mean_Infected2, ribbon=(Mean_Infected2 .- Low_quantile_Infected2,High_quantile_Infected2 .- Mean_Infected2), fillalpha=0.6, c=:blue, lab="Infected Prediction: No reopening", linewidth = 3, ylims = (-1.25*maximum(Recovered + Dead),1.5*maximum(Infected)))

savefig("NV_CLE_2.pdf")
