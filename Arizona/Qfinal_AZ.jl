...
######################## STAGE 1###############
vars = matread("C:/Users/Raj/Desktop/2.168/COVID-19-master_latest/COVID-19-master/csse_covid_19_data/csse_covid_19_daily_reports/Rise_AZ_Track.mat")

Random.seed!(50)

Infected = vars["AZ_Infected_All"]
Recovered = vars["AZ_Recovered_All"]
Dead= vars["AZ_Dead_All"]
Time = vars["AZ_Time"]
...
u0 = Float64[7280000.0, 652, 13, 10]
tspan = (0, 110.0)
datasize = 110;
...
save("QFinal_QuarHeatmap_AZ_QSIR_Deadn.jld",  "β_parameter", p3n[52],"γ_parameter", p3n[53],"δ_parameter", p3n[54], "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)
...
D = load("QFinal_QuarHeatmap_AZ_QSIR_Deadn.jld")
...
#gif(anim,"Quar_Dead_AZ.gif", fps=15)
L = findmin(Loss)
idx = L[2]
idx1 = (idx-1)*54 +1
idx2 = idx*54
...
savefig("QFinal_Quar_Stage2_AZ_1d.pdf")
...
Plots.savefig("QFinal_Quar_Stage2_AZ_2d.pdf")
...
Plots.savefig("QFinal_Quar_Stage2_AZ_3d.pdf")


Q_AZ = ((Q_parameter[30] - Q_parameter[1]) /u0[1])

save("QFinal_QuarHeatmap_AZ_QSIR_Deadn_Stage2.jld", "Q_AZ", Q_AZ, "prediction", prediction, "Q_parameter", Q_parameter, "Reff", Reff, "Transition", Transition, "β_parameter", p3n[52],"γ_parameter", γ_parameter,"δ_parameter", δ_parameter, "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)


########CLEAN PLOTS###########
D = load("QFinal_QuarHeatmap_AZ_QSIR_Deadn_Stage2.jld")
...
Plots.savefig("Clean_QFinal_Quar_Stage2_AZ_2d.pdf")

#plot([0, Transition[1]], [80, 80],fill=(0,:lightpink), markeralpha=0, label = "")
#plot!([Transition[1], datasize], [80, 80],fill=(0,:aliceblue), markeralpha=0, label = "")
scatter(t,Q_parameter/u0[1], xlims = (0, datasize), ylims = (0,1), xlabel = "Days post 500 infected", ylabel = "Q(t)", label = "Quarantine strength",color = :blue, framestyle = :box, grid =:off, legend = :topleft, left_margin = 5mm, bottom_margin = 5mm, foreground_color_legend = nothing, background_color_legend = nothing,  yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman"), legendfontsize = 12)

D1 = diff(Q_parameter[1:end], dims = 1)
D2 = diff(D1, dims = 1)
#Transitionn = findall(x -> x <0, D2)[2]

plot!([19-0.01,19+0.01],[0.0, 0.6],lw=3,color=:green,label="Stay-at-home order expires",linestyle = :dash)
savefig("AZ_reopen_Q.pdf")
...
Plots.savefig("Clean_QFinal_Quar_Stage2_AZ_3dn.pdf")

#######WHAT IF NO REOPENING##############

vars = matread("/Users/Emma/Documents/School/2019-2020/Covid Urop/Run Code 7:15/Rise_AZ_Track.mat")
Infected = vars["AZ_Infected_All"]
Recovered = vars["AZ_Recovered_All"]
Dead= vars["AZ_Dead_All"]
Time = vars["AZ_Time"]
...
plot!(t, prediction[3, :], ylims = (-0.05*maximum(Infected),1.5*maximum(Infected)), right_margin = 5mm, xaxis = "Days post 500 infected", label = "Prediction ", legend = :topleft, framestyle = :box, left_margin = 5mm, bottom_margin =5mm, top_margin = 5mm, grid = :off, color = :darkgreen, linewidth  = 4, foreground_color_legend = nothing, background_color_legend = nothing,  yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman", legendfontsize = 1))

savefig("AZ_reopen_1.pdf")
...
bar!(Recovered' + Dead',alpha=0.5,xrotation=60,label="Data: Recovered", color="blue")
plot!(t, prediction_noreopen[3, :], ylims = (-0.05*maximum(Recovered + Dead),1.5*maximum(Infected)), right_margin = 5mm, xaxis = "Days post 500 infected", label = "Prediction ", legend = :topleft, framestyle = :box, left_margin = 5mm, bottom_margin =5mm, top_margin = 5mm, grid = :off, color = :blue, linewidth  = 4, foreground_color_legend = nothing, background_color_legend = nothing,  yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman", legendfontsize = 1))
savefig("AZ_noreopen_count.pdf")
=#
