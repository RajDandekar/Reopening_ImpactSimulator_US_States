...
######################## STAGE 1###############
vars = matread("/Users/Emma/Documents/School/2019-2020/Covid Urop/csse_covid_19_data/csse_covid_19_daily_reports/Rise_FL_Track.mat")

Random.seed!(60)

Infected = vars["FL_Infected_All"]
Recovered = vars["FL_Recovered_All"]
Dead= vars["FL_Dead_All"]
Time = vars["FL_Time"]
...
u0 = Float64[21.48e6, Infected[1], Recovered[1] + Dead[1], 10]
tspan = (0, 117.0)
datasize = 117;
...
save("QFinal_QuarHeatmap_FL_QSIR_Deadn.jld",  "β_parameter", p3n[52],"γ_parameter", p3n[53],"δ_parameter", p3n[54], "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)
...
D = load("QFinal_QuarHeatmap_FL_QSIR_Deadn.jld")
...
#gif(anim,"Quar_Dead_FL.gif", fps=15)
L = findmin(Loss)
idx = L[2]
idx1 = (idx-1)*54 +1
idx2 = idx*54
...
savefig("QFinal_Quar_Stage2_FL_1d.pdf")
...
Plots.savefig("QFinal_Quar_Stage2_FL_2d.pdf")
...
Plots.savefig("QFinal_Quar_Stage2_FL_3d.pdf")


Q_FL = ((Q_parameter[30] - Q_parameter[1]) /u0[1])

save("QFinal_QuarHeatmap_FL_QSIR_Deadn_Stage2.jld", "Q_FL", Q_FL, "prediction", prediction, "Q_parameter", Q_parameter, "Reff", Reff, "Transition", Transition, "β_parameter", p3n[52],"γ_parameter", γ_parameter,"δ_parameter", δ_parameter, "S_NN_all_loss", S_NN_all_loss, "I_NN_all_loss", I_NN_all_loss, "R_NN_all_loss", R_NN_all_loss,"t", t, "Parameters", p3,"Parameters_copy", p3n, "Loss", Loss)


########CLEAN PLOTS###########
D = load("QFinal_QuarHeatmap_FL_QSIR_Deadn_Stage2.jld")
...
savefig("Clean_QFinal_Quar_Stage2_FL_1dn.pdf")
...
Plots.savefig("Clean_QFinal_Quar_Stage2_FL_2d.pdf")

#plot([0, Transition[1]], [80, 80],fill=(0,:lightpink), markeralpha=0, label = "")
#plot!([Transition[1], datasize], [80, 80],fill=(0,:aliceblue), markeralpha=0, label = "")
scatter(t,Q_parameter/u0[1], xlims = (0, datasize), ylims = (0,1.4), xlabel = "Days post 500 infected", ylabel = "Q(t)", label = "Quarantine strength",color = :black, framestyle = :box, grid =:off, legend = :topleft, left_margin = 5mm, bottom_margin = 5mm, foreground_color_legend = nothing, background_color_legend = nothing,  yguidefontsize = 14, xguidefontsize = 14,  xtickfont = font(12, "TimesNewRoman"), ytickfont = font(12, "TimesNewRoman"), legendfontsize = 12)

D1 = diff(Q_parameter[1:end], dims = 1)
D2 = diff(D1, dims = 1)
#Transitionn = findall(x -> x <0, D2)[2]

plot!([45-0.01,45+0.01],[0.0, 0.6],lw=3,color=:green,label="Stay-at-home order expires",linestyle = :dash)

#plot!([15-0.01,15+0.01],[0.0, 0.6],lw=3,color=:red,label="Inflection point in learnt Q(t)",linestyle = :dash)

Plots.savefig("Clean_QFinal_Quar_Stage2_FL_3dn.pdf")
